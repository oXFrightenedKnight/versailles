...
export default function Navbar() {
  ...
  return (
    <nav className="fixed h-14 inset-x-0 top-0 z-30 w-full border-b border-gray-200 bg-transparent backdrop-blur-lg transition-all  select-none">
      <MaxWidthWrapper className="h-full">
        <div className="flex h-full items-center justify-between border border-blue-500">
          <div
          ...
          {/* Main sections */}
          <div className="hidden md:flex h-full justify-between items-center border gap-5">
            <Button
          ...
          {/* Github + login */}
          <div className="h-full hidden md:flex justify-center items-center p-1.5">
            <div className="flex h-full justify-between items-center border gap-4">
              {!isSignedIn ? (
                <>
          ...
          <div className="md:hidden flex items-center gap-4 p-2">
            <Sheet open={open} onOpenChange={(isOpen) => setOpen(isOpen)}>
              ...
              <SheetContent
                side="right"
                className="h-full md:hidden bg-background text-primary-foreground flex z-100"
              >
